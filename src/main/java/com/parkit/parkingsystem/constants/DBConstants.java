...
public class DBConstants {
    ...
    public static final String GET_TICKET_BY_PARKING_SPOT_ID = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME WHERE t.OUT_TIME IS NULL AND PARKING_NUMBER=?";
}
